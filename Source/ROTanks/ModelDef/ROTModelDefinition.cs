...
namespace ROTanks
{
    ...
    public class ROTModelDefinition
    {
        ...
        public ROTModelDefinition(ConfigNode node)
        {
            ...
            actualHeight = node.GetFloatValue("actualHeight", actualHeight);
        ...
        {
            return ROTUtils.getNames(textureSets, m => m.name);
        }
        ...
        {
            return ROTUtils.getNames(textureSets, m => m.title);
        }
    ...
    public class ModelEngineTransformData
    {
        ...
        public ModelEngineTransformData(ConfigNode node)
        {
            ...
            if (string.IsNullOrEmpty(thrustTransformName)) { ROTLog.error("ERROR: THrust transform name was null for model def engine transform data"); }
    ...
    public class CompoundModelTransformData
    {
        ...
        public CompoundModelTransformData(ConfigNode node)
        {
            ...
            actualHeight = node.GetFloatValue("actualHeight");
